  ...
  const projects = [
    {
      ...
      completion: "2025-Q2",
      progress: 65,
      stakeholders: ["Shell", "Orsted", "Gasunie"],
    },
    {
      id: "2",
      ...
      completion: "2024-Q1",
      progress: 100,
      stakeholders: ["NextEra Energy", "Air Products"],
    },
    {
      id: "3",
      ...
      completion: "2026-Q4",
      progress: 25,
      stakeholders: ["Uniper", "RWE", "Thyssengas"],
    },
    {
      id: "4",
      ...
      completion: "2025-Q3",
      progress: 40,
      stakeholders: ["JERA", "Kawasaki Heavy Industries"],
    },
  ];
